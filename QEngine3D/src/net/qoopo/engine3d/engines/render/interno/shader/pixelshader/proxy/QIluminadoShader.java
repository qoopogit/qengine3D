...
import net.qoopo.engine3d.engines.render.interno.shader.pixelshader.basico.parciales.QIluminadoShaderBAS;
 ...
 * @author alberto
 */
public class QIluminadoShader extends QShader {

    private QShader basico;
    private QShaderNodos nodos;

    public QIluminadoShader(QMotorRender render) {
        super(render);
