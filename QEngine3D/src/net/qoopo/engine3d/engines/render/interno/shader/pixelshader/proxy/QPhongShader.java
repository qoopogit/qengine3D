...
import net.qoopo.engine3d.engines.render.interno.shader.pixelshader.basico.parciales.QPhongShaderBAS;
 ...
 * @author alberto
 */
public class QPhongShader extends QShader {

    private QShader basico;
    private QShaderNodos nodos;

    public QPhongShader(QMotorRender render) {
        super(render);
