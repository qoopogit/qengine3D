...
//        cam.setTipo(QCamara.FIJA_OBJETIVO);
        ...
        motor.getRenderer().opciones.verCarasTraseras = true;//para ver la sombra completa, al usar una esfera como sombra calcula las caras visibles y solo se ve media esfera
        motor.iniciar();
        while (true) {
            try {
                Thread.sleep(50);
