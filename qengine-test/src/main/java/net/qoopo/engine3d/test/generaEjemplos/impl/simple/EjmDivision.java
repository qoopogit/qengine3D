...
public class EjmDivision extends GeneraEjemplo {
    ...
    public void iniciar(QEscena mundo) {
        ...
        obj1.agregarComponente(QMaterialUtil.aplicarMaterial(new QTeapot(), new QMaterialBas(text)));
        obj1.mover(new QVector3(0, 0, 0));
        mundo.agregarEntidad(obj1);

        QEntidad obj2 = new QEntidad("esfera2");
        QGeometria g2 = new QTeapot();
        g2.dividir().suavizar();
        obj2.agregarComponente(QMaterialUtil.aplicarMaterial(g2, new QMaterialBas(text)));
        obj2.mover(new QVector3(-3, 0, 0));
        mundo.agregarEntidad(obj2);

        QEntidad obj3 = new QEntidad("esfera3");
        QGeometria g3 = new QTeapot();
        g3.dividirCatmullClark().suavizar();
        obj3.agregarComponente(QMaterialUtil.aplicarMaterial(g3, new QMaterialBas(text)));
