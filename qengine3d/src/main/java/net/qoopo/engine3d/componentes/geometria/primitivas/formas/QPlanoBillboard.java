 ...
 * @author alberto
 */
public class QPlanoBillboard extends QForma {
    ...
    public void construir() {
        try {
            ...
            this.agregarVertice(-ancho / 2, -alto / 2, 0, 0, 1); //primer vertice superiro
            this.agregarVertice(ancho / 2, -alto / 2, 0, 1, 1); //tercer vertice superior
            this.agregarVertice(ancho / 2, alto / 2, 0, 1, 0); //cuarto vertice superio
            this.agregarVertice(-ancho / 2, alto / 2, 0, 0, 0); //segundo vertice superior
