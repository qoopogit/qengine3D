...
public class QSombraCono extends QProcesadorSombra {
    ...
    public QSombraCono(QEscena mundo, QLuzSpot luz, QCamara camaraRender, int ancho, int alto) {
        super(mundo, luz, ancho, alto);
        try {
            renderSombra = new QRenderSombras(QRenderSombras.NO_DIRECCIONALES, mundo, luz, camaraRender, ancho, alto);
            renderSombra.resize();
